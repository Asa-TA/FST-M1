...
SELECT * FROM orders 
WHERE salesman_id=(SELECT DISTINCT salesman_id FROM orders WHERE customer_id=3003);

SELECT * FROM customers 
WHERE salesman_id=(SELECT DISTINCT salesman_id FROM orders WHERE customer_id=3003);

SELECT * FROM customers 
WHERE salesman_id=(SELECT DISTINCT salesman_id FROM customers WHERE customer_id=3003);
