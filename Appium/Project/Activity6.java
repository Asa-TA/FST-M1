...
public class Activity6 {
	...
	public void loginTest() {
		...
		wait.until(ExpectedConditions
				.elementToBeClickable(AppiumBy.xpath("//android.widget.TextView[@text=\"Popups\"]"))).click();
		wait.until(ExpectedConditions.elementToBeClickable(AppiumBy.xpath("//android.widget.Button[@text=\"Sign In\"]"))).click();
		
		wait.until(ExpectedConditions
				.elementToBeClickable(AppiumBy.xpath("//android.webkit.WebView[@text=\"Popups\"]/android.view.View[2]/android.view.View/android.view.View/android.view.View/android.widget.EditText[1]")))
		.sendKeys("admin");
		driver.findElement(AppiumBy.xpath("//android.view.View[@text=\"Password\"]")).sendKeys("password");
	...
	public void loginfailTest() {
		...
		wait.until(ExpectedConditions
				.elementToBeClickable(AppiumBy.xpath("//android.webkit.WebView[@text=\"Popups\"]/android.view.View[2]/android.view.View/android.view.View/android.view.View/android.widget.EditText[1]")))
		.sendKeys("Admin");
		driver.findElement(AppiumBy.xpath("//android.view.View[@text=\"Password\"]")).sendKeys("incorrectpw");
		driver.findElement(AppiumBy.xpath("//android.widget.Button[@text=\"Log in\"]")).click();
