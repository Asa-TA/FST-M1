...
public class Activity5 {
	...
	public void loginTest() {
		...
		wait.until(ExpectedConditions
				.elementToBeClickable(AppiumBy.xpath("//android.view.View[@resource-id=\"loginOverlay\"]/android.view.View/android.view.View/android.widget.EditText[1]")))
		.sendKeys("admin");
	...
	public void loginfailTest() {
		...
		.sendKeys("Admin");
		driver.findElement(AppiumBy.xpath("//android.webkit.WebView[@text=\"Login Form\"]/android.view.View/android.view.View/android.view.View/android.view.View/android.widget.EditText[2]")).sendKeys("Wrongpw");
		driver.findElement(AppiumBy.xpath("//android.widget.Button[@text=\"Log in\"]")).click();
